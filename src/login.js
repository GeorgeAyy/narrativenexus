  ...
  const handleSubmit = async (e) => {
    ...
    if (isValid) {
      try {
        ...
        if (response.ok) {
          // Authentication was successful, redirect to Home.js
          // You can use react-router-dom's useHistory for redirection
        ...
        // Handle sign-in error (e.g., network error)
